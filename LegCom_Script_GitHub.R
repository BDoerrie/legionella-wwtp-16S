...
raw_ASV_table <- read.csv2("Input_files/ASV_Table_DADA2.csv")
...
Leg_DB <- readDNAStringSet("./Input_files/legionella_database.fasta")
...
blast_out <- read.csv2("Input_files/BLASTn_output.csv")
...
dada2_asvid<-read.csv2("Input_files/dada2id_asvid.csv")
...
Val_corr<-read.csv2("Input_files/For_alpha_corr_avg.csv")
num_data <- Val_corr[, -1]
