...
#WWTP A####
#AS
tiff("Venn_A_AS.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(1:5)
df<-legionella_matrix_bi[select_rows,]
...
names(venn_list) <- SampleNames[select_rows]
...
#TWW
tiff("Venn_A_TWW.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(26:30)
df<-legionella_matrix_bi[select_rows,]
...
#WWTP B####
#AS
tiff("Venn_B_AS.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(6:10)
df<-legionella_matrix_bi[select_rows,]
...
#TWW
tiff("Venn_B_TWW.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(31:35)
df<-legionella_matrix_bi[select_rows,]
...
#WWTP C####
#AS
tiff("Venn_C_AS.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(11:15)
df<-legionella_matrix_bi[select_rows,]
...
#TWW
tiff("Venn_C_TWW.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(36:40)
df<-legionella_matrix_bi[select_rows,]
...
#WWTP D####
#AS
tiff("Venn_D_AS.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(16:20)
df<-legionella_matrix_bi[select_rows,]
...
#TWW
tiff("Venn_D_TWW.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(41:45)
df<-legionella_matrix_bi[select_rows,]
...
#WWTP E####
#AS
tiff("Venn_E_AS.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(21:25)
df<-legionella_matrix_bi[select_rows,]
...
#TWW
tiff("Venn_E_TWW.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(46:50)
df<-legionella_matrix_bi[select_rows,]
...
#WWTPA no winter####
#AS
tiff("Venn_A_AS_noWinter.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(1:4)
df<-legionella_matrix_bi[select_rows,]
...
#TWW
tiff("Venn_A_TWW_noWinter.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(26:29)
df<-legionella_matrix_bi[select_rows,]
...
#WWTP D no winter####
#AS
tiff("Venn_D_AS_noWinter.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(16:19)
df<-legionella_matrix_bi[select_rows,]
...
#TWW
tiff("Venn_D_TWW_noWinter.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(41:44)
df<-legionella_matrix_bi[select_rows,]
...
#AS
tiff("Venn_E_AS_2023.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(21:24)
df<-legionella_matrix_bi[select_rows,]
...
#TWW
tiff("Venn_E_TWW_2023.tiff", units="cm", width=30, height=25, res=300)
select_rows<-c(46:49)
df<-legionella_matrix_bi[select_rows,]
...
Species_assigned<-read.csv2("data/Species_assigned.csv")
